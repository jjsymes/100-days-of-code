...
notification_manager = NotificationManager(TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, TWILIO_FROM_NUMBER)
...
for flight in flight_data:
    ...
    if flight_search_result['_results'] > 0:
        notification_manager.send_sms_notification(notification, TWILIO_TO_NUMBER)
